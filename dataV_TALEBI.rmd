...
###  Based on data the global rate of death due to air pollution (total deaths per 100,000) has been decreasing, Fig. (1). Additionally, total CO<sub>2</sub> does not follow a monotonic trend and during last three decades has been oscillating.
